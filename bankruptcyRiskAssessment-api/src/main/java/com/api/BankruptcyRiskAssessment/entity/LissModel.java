...
@Entity(name = "LissModel")
@Table(name = "lissModel")
@EntityListeners(AuditingEntityListener.class)
public class LissModel implements Serializable {
    ...
    public LissModel(double z, double x1, double x2, double x3, double x4, Company company){
        this.z = z;
        this.x1 = x1;
        this.x2 = x2;
        this.x3 = x3;
